...
COVER = r'C:\Users\mmail\Desktop\fatigue_detecting-master 2\fatigue_detecting-master\images\camera.png'
...
class Fatigue_detecting(wx.Frame):
    ...
    def _learning_face(self,event):
        ...
        self.predictor = dlib.shape_predictor(r"C:\Users\mmail\Desktop\fatigue_detecting-master 2\fatigue_detecting-master\model\shape_predictor_68_face_landmarks.dat")
